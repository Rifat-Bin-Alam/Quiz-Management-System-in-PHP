...
<head>
    ...
    <style>
        ...
        button { padding:0.4rem 0.8rem; background-color:lightblue; color:#042A38; border:none; border-radius:5px; cursor:pointer; margin:0.3rem; }
...
<div class="container">
    <div class="actions">
        <a href="take_quiz.php"><button>Take Quiz</button></a>
        <a href="view_score.php"><button>View All Scores</button></a>
    </div>
    ...
    <table>
        ...
        <tbody>
        <?php
        $sql = "SELECT s.score_point, s.total_point, s.quiz_id, q.quiz_name, s.score_id, s.date_created
                FROM score s
