...
a { color:#042A38; text-decoration:none; display:block; margin-top:0.5rem; font-size:0.9rem; }
.show-pass { display:flex; justify-content:flex-start; align-items:center; font-size:0.9rem; margin-bottom:0.5rem; }
