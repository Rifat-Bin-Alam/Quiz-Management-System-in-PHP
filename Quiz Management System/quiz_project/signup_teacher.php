...
if(isset($_POST['submit'])){
    ...
    if($password !== $cpassword){
        ...
        if(mysqli_num_rows($check) > 0){
            ...
            $sql = "INSERT INTO teacher (t_name,email,password,phone_no,status) VALUES ('$name','$email','$password','$phone','pending')";
            if(mysqli_query($conn,$sql)){
                $message = "<p style='color:green;'>Registration Submitted! Await admin approval. You can now <a href='teacher_login.php'>login</a> after approval.</p>";
            } else {
